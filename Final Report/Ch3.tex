...
\end{enumerate}
\end{enumerate}
\protect\caption{\label{alg:ASR}\foreignlanguage{australian}{ \acs{ASR} with \acs{HTK}}\selectlanguage{australian}%
}
\end{algorithm}
...
data consisting of drawn phonemes, \textbf{\inputencoding{latin1}{\nameref{sub:Phoneme-Training}}\inputencoding{latin9}};
and secondly modifying the training algorithm itself to be phoneme
dependent, \textbf{\inputencoding{latin1}{\nameref{sub:Phoneme-Base}}\inputencoding{latin9}}.
...
used to produce drawn phoneme recordings is given in \Cref{lst:drawPhnSamples,lst:getSpeakerFiles,lst:getPhnData}.
...
\lstref{NMF-train}. With the simplified \lstinline[language=bash]!dummyTrain!
