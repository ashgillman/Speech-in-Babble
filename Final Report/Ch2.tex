...
Long-term \ac{SNR} is the involves calculating the \ac{SNR} over
the entire signal. However, this method does not always correlate
with subjective measures \citep{Hansen1998} and many variations exist.
For example, \citet{Raj2005a} utilise a method incorporating the
phase of the signal.
