...
shows the data fitted with a \acf{LOESS} model and \figref{Direct-PESQ-PRR-LM}
...
first two columns in \figref{mos-comparison-phn-1}, which were the
...
with some lower frequency components. The same phonemes in \figref{mos-comparison-phn-5}
...
as best observed in \figref{prrcorr-comparison-phn}. In terms of
...
a smaller number of the tests instead showed a slight decrease. \figref{my-Corr}
